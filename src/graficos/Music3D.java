...
public class Music3D extends Objeto3D implements Runnable {
    ...
    public Music3D(int frameWidth, int frameHeight, double[] origenCubo, double[] puntoFuga, LabelManager labelManager) {
    ...
    private void initVertices() {
        ...
        InputStream inputStream = classLoader.getResourceAsStream("recursos/music.obj");
