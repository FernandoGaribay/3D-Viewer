...
public class Esfera3D extends Objeto3D implements Runnable {

    private final Thread hiloCubo;

    private Modelo3D modelo = new Modelo3D();

    public Esfera3D(int frameWidth, int frameHeight, double[] origenCubo, double[] puntoFuga, LabelManager labelManager) {
    ...
    private void initEtiqueta() {
        JLabel etiquetaActual = new JLabel("Esfera #" + (idObjeto + 1));
