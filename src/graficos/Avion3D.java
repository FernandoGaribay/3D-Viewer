...
public class Avion3D extends Objeto3D implements Runnable {
    ...
    public Avion3D(int frameWidth, int frameHeight, double[] origenCubo, double[] puntoFuga, LabelManager labelManager) {
    ...
    private void initEtiqueta() {
        JLabel etiquetaActual = new JLabel("Avion #" + (idObjeto + 1));
    ...
    private void initVertices() {
        ...
        InputStream inputStream = classLoader.getResourceAsStream("recursos/avion.obj");
