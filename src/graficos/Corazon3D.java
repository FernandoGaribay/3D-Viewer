...
public class Corazon3D extends Objeto3D implements Runnable {

    private final Thread hiloCubo;

    private Modelo3D modelo = new Modelo3D();

    public Corazon3D(int frameWidth, int frameHeight, double[] origenCubo, double[] puntoFuga, LabelManager labelManager) {
    ...
    private void initEtiqueta() {
        JLabel etiquetaActual = new JLabel("Corazon #" + (idObjeto + 1));
    ...
    private void initVertices() {
        ...
        InputStream inputStream = classLoader.getResourceAsStream("recursos/corazon.obj");
